...
public class TreeNode {
	...
	TreeNode(int mazeRow, int mazeCol, boolean isRoot, boolean isWall, boolean isPlayerLoc, boolean isGoal, boolean isVisited){
		this.row = mazeRow;
		this.col = mazeCol;
		this.isRoot = isRoot;
		this.isWall = isWall;
	...
	TreeNode(int mazeRow, int mazeCol, boolean isRoot, boolean isWall, boolean isPlayerLoc, boolean isGoal, boolean isVisited, boolean isGhost, boolean isGhostPath){
		this.row = mazeRow;
		this.col = mazeCol;
		this.isRoot = isRoot;
		this.isWall = isWall;
